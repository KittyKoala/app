...
public class ApiTerminalController extends BaseController {
    ...
    public Response genThumb() throws Exception {
        ...
        for (File file : files) {
            ...
            String thumbPath = sourcePath.substring(0, sourcePath.lastIndexOf("photo/")) + "photo/thumb/" + sourcePath.substring(sourcePath.indexOf("photo/") + 6, sourcePath.lastIndexOf(".")) + "_THUMB.png";
