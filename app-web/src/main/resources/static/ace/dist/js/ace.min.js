...
!function () {
    ...
    function c(b, c) {
        var f = this, g = a(window), h = a(b), i = h.find(".nav-list"), j = h.find(".sidebar-toggle").eq(0),
            k = h.find(".sidebar-shortcuts").eq(0), l = i.get(0);
        if (l) {
    ...
    function c(b, c) {
        ...
        function k(c) {
            ...
            g && (o = n, m.top += o);
            var u = parseInt(m.top + r), x = 0, y = t.height(), z = parseInt(m.top - k - o), A = y, B = q.horizontal,
                C = !1;
        ...
        var x = -1, y = d ? "touchstart.sub_hover" : "mouseenter.sub_hover",
    ...
    var d = function (b) {
        ...
        this.reload = function () {
            ...
            var c = this.$box, d = c.find(".widget-body").eq(0), e = null,
